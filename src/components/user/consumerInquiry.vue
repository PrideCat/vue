<template>
  <div>
    ...
    <el-table :class="lang.lang=='en'?'langIsEn':''" :data="tableData" border style="width: 100%;" @row-click="clickTable">
  ...
  export default {
    ...
    methods: {
      handleSizeChange: function (val) {
        this.size = val;
        this.api(this, '/user/registerRetrive', {type:0, no: this.no, size: this.size}, res => {
