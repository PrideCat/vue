      ...
      <div :style="collapseAttr.formBoxStyle">
        ...
        <el-form-item :label="lang[lang.lang].passwordConfirmation" prop="passwordConfirmation">
          <el-input type="password" v-model="form.passwordConfirmation"
                    :placeholder="lang[lang.lang].editpasswordConfirmation"></el-input>
        </el-form-item>
      </div>
    </div>
    <div class="fromBox">
    ...
    data() {
      ...
      return {
        ...
        rules: {
          ...
          passwordConfirmation: [
            {required: true, message: langJson[lang].editpasswordConfirmation, trigger: 'blur'},
            {
              validator: (rule, value, callback, source, options) => {
                var errors = [];
                if (this.form.newPassword && this.form.newPassword !== this.form.passwordConfirmation) errors.push(new Error(langJson[lang].editpasswordConfirmation1));
                callback(errors);
              }
            }
          ]
    ...
    methods: {
      onSubmit: function () {
        ...
        this.$refs.form.validate(valid => {
          if (valid) {
            this.api(this, "/user/paymentPassword", {
