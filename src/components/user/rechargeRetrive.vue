  ...
  <div id="rechargeRetrive">
    ...
    <div class="fromBox">
      ...
      <el-table :class="lang.lang=='en'?'langIsEn':''" :data="tableData" border style="width: calc(100% - 20px);margin: 0 10px;">
        ...
        <el-table-column prop="money" :label="lang[lang.lang].en8" align="center" width="180"></el-table-column>
        <el-table-column prop="createTime" :label="lang[lang.lang].en9" align="center" width="240"></el-table-column>
        <el-table-column prop="depositTime" :label="lang[lang.lang].en10" align="center" width="240"></el-table-column>
        <el-table-column prop="bankName" :label="lang[lang.lang].en11" align="center" width="180"></el-table-column>
        <el-table-column prop="bankAccount" :label="lang[lang.lang].en12" align="center" width="180"></el-table-column>
        <el-table-column prop="serialNumber" :label="lang[lang.lang].en13" align="center" width="180"></el-table-column>
        <el-table-column prop="trace" :label="lang[lang.lang].en14" align="center" width="140">
    ...
    <div class="winup listInfo" v-if="winup.isShow">
      <div style="max-height: 100%;overflow: auto;">
        <p><span>{{lang[lang.lang].en18}}</span><b @click="winupClose()">×</b></p>
        <ul>
          <li>
            <ol style="margin-top: -30px;">
              ...
              <li>
                <p><span>{{lang[lang.lang].en11}}</span><b>{{winup.data.bankName}}</b></p>
              </li>
              <li>
                <p><span>{{lang[lang.lang].en12}}</span><b>{{winup.data.bankAccount}}</b></p>
              </li>
              <li>
              ...
              <li style="width: 100%;"><p><span>{{lang[lang.lang].en6}}</span><b>{{winup.data.orderNumber}}</b></p></li>
              <li style="width: 100%;"><p><span>{{lang[lang.lang].en8}}</span><b>{{winup.data.money}}</b></p></li>
              <li style="width: 100%;"><p><span>{{lang[lang.lang].en9}}</span><b>{{winup.data.createTime}}</b></p></li>
              <li style="width: 100%;"><p><span>{{lang[lang.lang].en10}}</span><b>{{winup.data.depositTime}}</b></p></li>
              <li style="width: 100%;"><p><span>{{lang[lang.lang].en11}}</span><b>{{winup.data.bankName}}</b></p></li>
              <li style="width: 100%;"><p><span>{{lang[lang.lang].en12}}</span><b>{{winup.data.bankAccount}}</b></p></li>
              <li style="width: 100%;"><p><span>{{lang[lang.lang].en13}}</span><b>{{winup.data.serialNumber}}</b></p></li>
              <li style="width: 100%;"><p><span>{{lang[lang.lang].en41}}</span><b><img style="width:400px;" :src="winup.data.receiptPic"></b></p></li>
              <li style="width: 100%;"><p><span>{{lang[lang.lang].en14}}</span><b>{{winup.data.trace==0?lang[lang.lang].en3:(winup.data.trace==1?lang[lang.lang].en4:lang[lang.lang].en5)}}</b></p></li>
            </ol>
          </li>
...
<script>
  export default {
    ...
    methods: {
      ...
      init(){
        this.api(this, '/manager/recharge/retrive', this.search, res => {
          console.log(res);
      ...
      winupClose(orderNumber,uid,isNo){
        if(uid){
          ...
          this.$confirm(isNo?this.lang[this.lang.lang].en110:this.lang[this.lang.lang].en111).then(_ => {
            this.api(this, '/manager/recharge/audit', {orderNumber,uid,trace:isNo?0:2}, res => {
              console.log(res);
              this.init();
