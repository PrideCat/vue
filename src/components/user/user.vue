<template>
  <div
    id="main"
    :class="(userInfo.agreement==0&&!(userInfo.type==0&&(userInfo.rank==1||userInfo.rank==2)))||forgetPassword?'agree':''"
  >
    <div id="theTop">
    ...
    <el-container>
            ...
            <el-submenu v-if="item.children" :index="item.index">
              ...
              <div v-for="item in item.children" v-if="!item.isHide">
                <el-menu-item :index="item.index">
                  <router-link
                    tag="div"
                    :class="item.icon?'menuIconBox':''"
                    :to="{name:item.url.split('.html')[0]}"
                  >
                    <i v-html="item.icon"></i>
                    <b>{{item[lang.lang]}}</b>
                  </router-link>
      ...
      <el-container>
          ...
          <ul id="info">
            <li>
              <router-link tag="div" :to="{name:'modify'}">
                <p>
                  <img src="../../../static/img/user.png" height="30" width="24">
                </p>
            ...
            <li>
              <router-link tag="div" :to="{name:'announce'}">
                <p>
                  <img src="../../../static/img/notic.png" height="28" width="25">
                </p>
            ...
            <li>
              <div @click="toMall">
                <p>
                  <img src="../../../static/img/shopping.png" height="28" width="28">
                </p>
        ...
        <el-main>
          <div
            style="margin: -20px -20px 0;padding: 12px 10px 12px 20px;"
            v-if="userInfo.activate!=0&&userInfo.activate!=1&&pageI!=1"
          >
            <el-breadcrumb separator-class="el-icon-arrow-right">
              <el-breadcrumb-item>
                <router-link
                  style="color:#303133;text-decoration: unset;"
                  to="index"
                >{{lang[lang.lang].home}}</router-link>
              </el-breadcrumb-item>
              <el-breadcrumb-item
                v-if="activeIndex.split('-').length>1&&!isIndex"
              >{{menuArray[menuArrayIndexs.indexOf(activeIndex.split("-")[0])][lang.lang]}}</el-breadcrumb-item>
              <el-breadcrumb-item
                v-if="!isIndex"
              >{{menuArray[menuArrayIndexs.indexOf(activeIndex)][lang.lang]}}</el-breadcrumb-item>
            </el-breadcrumb>
          </div>
          <div id="mobileHead">
            <p>
              <i @click="mobileMenuIsShow = true;">
                <svg viewBox="0 0 1214 1024" width="20">
                  <path
              ...
              <router-link tag="i" to="announce">
                <svg viewBox="0 0 1024 1024" width="25">
                  <path
                    d="M838.4 771.9H207.1c-19.5 0-36.1-11.9-42.2-30.4-6.2-18.5-0.1-38 15.5-49.7 55.6-41.7 88.7-108 88.7-177.5V383c0-37.7 8.5-73.9 25.3-107.7 15.9-32.1 39.3-60.8 67.5-83.2 58.7-46.5 134.7-63.1 208.6-45.7 53.1 12.5 100.8 44.1 134.5 89 32.8 43.8 50.9 98.3 50.9 153.5v125.4c0 38 9.9 75.6 28.5 108.8 6.8 12 2.5 27.3-9.5 34-12 6.8-27.3 2.5-34-9.5C718.1 607 706 560.9 706 514.3V389c0-92.2-61.8-173.7-146.8-193.8-58.9-13.9-119.4-0.7-166.1 36.2-46.9 37.1-73.8 92.4-73.8 151.6v131.3c0 42-9.9 84-28.7 121.6-16.4 32.8-39.6 62.3-67.6 86h615.6c13.8 0 25 11.2 25 25s-11.4 25-25.2 25zM512.5 962.3c-67.3 0-122-54.7-122-122 0-13.8 11.2-25 25-25s25 11.2 25 25c0 39.7 32.3 72 72 72s72-32.3 72-72c0-13.8 11.2-25 25-25s25 11.2 25 25c0 67.3-54.7 122-122 122z"
                  ></path>
                  <path d="M512.5 116.2m-52.2 0a52.2 52.2 0 1 0 104.4 0 52.2 52.2 0 1 0-104.4 0Z"></path>
                </svg>
              </router-link>
              <i @click="toMall">
                <svg viewBox="0 0 1024 1024" width="23">
                  <path
                    d="M955.68152 227.327472c0-20.390399-16.58984-36.919864-37.050848-36.919864L296.064484 190.407608c-4.54041 0-8.887414 0.816598-12.906961 2.304486L249.814114 89.716324c-5.824659-17.46272-23.482831-27.691689-41.148166-24.790616-0.51063-0.021489-1.022283-0.038886-1.537006-0.038886L103.365694 64.886823c-20.466124 0-37.058011 16.530488-37.058011 36.919864 0 20.387329 16.591887 36.916794 37.058011 36.916794l84.443227 0 148.250462 457.939757L227.71377 730.032782c-12.879332 15.84999-10.423397 39.09439 5.487991 51.92051 10.015098 8.075933 22.969131 10.090822 34.406624 6.52767l628.78175 0c20.470217 0 37.061081-16.531512 37.061081-36.920888 0-20.386306-16.590863-36.916794-37.061081-36.916794l-560.833195 0 59.982116-73.832566 404.50373 0c20.218484 0 36.643572-16.135492 37.038568-36.182061 0.037862-0.110517 0.081864-0.218988 0.118704-0.329505L953.602162 253.804497c2.060939-6.202259 2.371-12.559037 1.213641-18.547425C955.376575 232.700853 955.68152 230.05049 955.68152 227.327472zM771.533476 566.972009 404.319024 566.972009l-98.003058-302.727743 565.756321 0L771.533476 566.972009zM518.407432 493.136374c20.466124 0 37.056987-16.530488 37.056987-36.918841l0-95.986121c0-20.389376-16.590863-36.917818-37.056987-36.917818-20.465101 0-37.054941 16.528442-37.054941 36.917818l0 95.986121C481.352491 476.605885 497.942331 493.136374 518.407432 493.136374zM681.461041 493.136374c20.466124 0 37.054941-16.530488 37.054941-36.918841l0-95.986121c0-20.389376-16.588817-36.917818-37.054941-36.917818s-37.055964 16.528442-37.055964 36.917818l0 95.986121C644.405077 476.605885 660.994917 493.136374 681.461041 493.136374zM347.945085 840.165088c-32.748868 0-59.295478 26.446325-59.295478 59.07035 0 32.620955 26.546609 59.069327 59.295478 59.069327 32.745798 0 59.291384-26.448372 59.291384-59.069327C407.235446 866.61039 380.690884 840.165088 347.945085 840.165088zM807.457664 840.165088c-32.749892 0-59.294454 26.446325-59.294454 59.07035 0 32.620955 26.544563 59.069327 59.294454 59.069327 32.744775 0 59.290361-26.448372 59.290361-59.069327C866.749048 866.61039 840.202439 840.165088 807.457664 840.165088z"
                  ></path>
                </svg>
              </i>
            </p>
    ...
    <div class="foot">
      ...
      <p>
        <a @click="toMall">{{lang[lang.lang].en53}}</a> |
        <a @click="toMall">{{lang[lang.lang].en57}}</a>
      </p>
    ...
    <div class="winup" id="DailyReminder" v-if="winup.isShow">
      <div>
        <p>
          <span>{{lang[lang.lang].en58}}</span>
          <b @click="winupClose">×</b>
        </p>
        <ul>
          ...
          <!-- <li>xxxxx@qq.com</li> -->
          <li>
            <a href="javascript:void(0);" @click="winupClose">{{lang[lang.lang].en61}}</a>
          </li>
          <li :class="winup.hasRemind?'':'active'" @click="winup.hasRemind=!winup.hasRemind">
            <i></i>
    ...
    <div id="mobileMenu" :class="mobileMenuIsShow?'show':''" @click="mobileMenuIsShow = false;">
      <ul class="m_content" @click.stop>
        <li>
          <p>
            <i @click="mobileMenuIsShow = false;">×</i>
          </p>
        </li>
        <li>
          <ol>
        ...
        <li>
          ...
          >
            ...
            <div
              ...
              v-if="(userInfo.authority!=0||!item.ishide)&&!item.isHide"
            >
              <el-submenu v-if="item.children" :index="item.index">
                <template slot="title">
                  <div :class="item.icon?'menuIconBox':''">
        ...
        <li>
          <p>
            <a @click="selectLang(lang.lang=='cn'?'en':'cn')">{{lang[lang.lang].en76}}</a>
            <a @click="exit">{{lang[lang.lang].en49}}</a>
          </p>
        </li>
      </ul>
    </div>
...
export default {
  ...
  data() {
    ...
    let weekEndDate = returnWeek(date.getFullYear() + "_" + getWeekOfYear())
      .split("~")[1]
      .replace(/日/, "")
      .replace(/年|月/g, "-")
      .split("-");
    ...
    weekEndDate = `${weekEndDate.getFullYear()}年${weekEndDate.getMonth() +
      1}月${weekEndDate.getDate()}日`;
    return {
      isActivate,
      collapseAttr,
      menuData,
      ...
      winup: {
        isShow:
          localStorage.getItem("winupHasRemind") == date.getTime()
            ? false
            : true,
        hasRemind: true,
  ...
  methods: {
    ...
    winupClose() {
      ...
      const date = new Date();
      date.setHours(0, 0, 0, 0);
      if (!this.winup.hasRemind)
        localStorage.setItem("winupHasRemind", date.getTime());
    },
    getNowIndex() {
    ...
    init() {
      ...
      this.getNowIndex();
      if (
        userInfo.agreement == 0 &&
        !(userInfo.type == 0 && (userInfo.rank == 1 || userInfo.rank == 2))
      )
        this.$router.push("agreement");
      else if (
        (userInfo.activate == 0 || userInfo.activate == 1) &&
        !(userInfo.type == 0 && (userInfo.rank == 1 || userInfo.rank == 2))
      )
  ...
  mounted() {
    ...
    if (this.global.isNewUserInfo)
      if (this.activeIndex.split("-").length > 1)
        this.theOpenMenuI = this.activeIndex.split("-")[0];
    document.onscroll = _ => {
      let scrollTop =
        (document.documentElement || document.body).scrollTop - 140; //125
      $(".el-aside > .el-menu").css("top", scrollTop > 0 ? scrollTop : 0); //*(100/110)
    };
    console.log(this.userInfo.authority);
    if (this.userInfo.authority != 2) {
      try {
        this.menuData[6].children[4].isHide = true;
      } catch (error) {}
    }
  },
  created() {
    try {
      if (
        ...
        (this.userInfo.rank == 1 || this.userInfo.rank == 2)
      ) {
...
#mobileMenu .m_content > li:nth-child(4) p a:last-child:before {
  background: url(../../../static/img/exit.png);
  content: "";
  display: inline-block;
  width: 13px;
  height: 13px;
...
.winup > div ul li:nth-child(4),
.winup > div ul li:nth-child(5) {
  position: relative;
}
.winup > div ul li:nth-child(4) {
  top: 7px;
...
.winup > div ul li:last-child {
  cursor: pointer;
  user-select: none;
}
.winup > div ul li span {
  font-size: 12px;
  color: #4583ce;
}
.winup > div ul li i {
...
.winup > div ul li.active i:before {
  content: "";
  width: 6px;
  height: 6px;
  background: #4583ce;
